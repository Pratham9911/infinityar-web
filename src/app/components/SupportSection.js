    ...
    <section className="relative min-h-screen bg-[#101923] text-white font-['Space_Grotesk','Noto_Sans',sans-serif] overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-10 py-5">
        <div className="flex flex-col gap-3 max-w-[960px] mx-auto">
          ...
          <h2 className="text-[22px] font-bold tracking-[-0.015em] pt-5">Contact Us</h2>
          ...
          <h2 className="text-[22px] font-bold tracking-[-0.015em] pt-5">Troubleshooting</h2>
          ...
          <h2 className="text-[22px] font-bold tracking-[-0.015em] pt-5">Contact Details</h2>
          <div className="grid grid-cols-[20%_1fr] gap-x-6 px-4">
